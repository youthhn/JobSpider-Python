...
class JobSpider:
    ...
    def job_spider(self):
        ...
        """
        keywd=u'软件'
        url = "http://search.51job.com/jobsearch/search_result.php?fromJs=1&jobarea=&keyword="+keywd+"&keywordtype=2&lang=c&stype=2&postchannel=0000&fromType=1&confirmdate=9"
